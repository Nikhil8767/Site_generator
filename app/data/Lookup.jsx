...
export default {
  ...
  SIGNIN_HEADING: 'Continue With our PromptPixel',
  SIGNIN_SUBHEADING: 'To use PromptPixel you must log into an existing account or create one.',
  SIGNIn_AGREEMENT_TEXT: 'By using PromptPixel, you agree to the collection of usage data for analytics.',
